...
You can download the sample APK from this repo here: https://github.com/DmitryMalkovich/circular-with-floating-action-button/releases/tag/v1.3

### Usage

- Add to your project `ProgressFloatingActionButton.java` manually or via **Gradle**
```
compile 'com.dmitrymalkovich.android:progress-fab:1.3'
```
